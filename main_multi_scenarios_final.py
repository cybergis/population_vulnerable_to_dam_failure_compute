...
if __name__ == "__main__":
    ...
    # Anvil directory
    data_dir = "/job/aging_dam_data"
    output_dir = os.path.join("/job/result", f'Multi_F_Results_NWFim_Queen', f'N_{iter_num}')
    ...
    # TODO: change this to read a parameter
    fed_dams = fed_dams.loc[fed_dams['ID'] == 'CA10022']
    ...
    fim_output = gpd.GeoDataFrame(fim_output)
    mi_result = gpd.GeoDataFrame(mi_result)
    lm_result = gpd.GeoDataFrame(lm_result)
